...
RUN dnf install --installroot /mnt/rootfs vim wget iputils curl telnet --releasever 9 --setopt install_weak_deps=false --nodocs -y; dnf --installroot /mnt/rootfs clean all
